                                ...
                                <div class="col-md-6">
                                    <div class="avatar-upload">
                                        ...
                                        <div class="avatar-preview">
                                            <img width="50px" height="50px" src="{{ $user->profile_picture ? asset('public/uploads/freelancers/profiles/' . basename($user->profile_picture)) : asset('public/assets/images/usr_avatar.png') }}" />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="cover-upload">
                                        ...
                                        <div class="cover-preview">
                                            <img width="50px" height="50px" src="{{ $user->cover_photo ? asset('public/uploads/freelancers/covers/' . basename($user->cover_photo)) : asset('public/assets/images/usr_avatar.png') }}" />
                                        </div>
                                    </div>
                                </div>
                            </div>
